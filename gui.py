...
def desktopGeometry():
    return QtGui.QDesktopWidget().availableGeometry()

def adjustWindowSize(window, widgetWidth, widgetHeight):
    ...
    scrollbarWidth = QtGui.qApp.style().pixelMetric(QtGui.QStyle.PM_ScrollBarExtent)
...
class DialogPower(QtGui.QDialog):
    c = None
    p = None
    ...
    def __init__(self, parentWindow):
        ...
        layout.addWidget(QtGui.QLabel("Function: c * i ^ p"))
        ...
        self.center1 = QtGui.QWidget(self)
        self.layout3 = QtGui.QHBoxLayout(self.center1)
        self.center1.setLayout(self.layout3)
        self.layout3.addWidget(QtGui.QLabel("p ="))
        self.textfieldP = QtGui.QLineEdit(self.center1)
...
class DialogShape(QtGui.QDialog):
    function = None
    center = None
    width = None
    times = None
    ...
    def __init__(self, parentWindow):
        ...
        layout.addWidget(QtGui.QLabel("Target histogram"))
        
        self.center = QtGui.QWidget(self)
        self.layout1 = QtGui.QGridLayout(self.center)
        self.center.setLayout(self.layout1)
        self.layout1.addWidget(QtGui.QLabel("Function: "), 0, 0)
        self.boxFunction = QtGui.QComboBox(self.center)
        ...
        #
        self.layout1.addWidget(QtGui.QLabel("Center (Mean): "), 1, 0)
        self.textfieldCenter = QtGui.QLineEdit(self.center)
        ...
        #
        self.layout1.addWidget(QtGui.QLabel("Width (Variance): "), 2, 0)
        self.textfieldWidth = QtGui.QLineEdit(self.center)
        ...
        #
        self.layout1.addWidget(QtGui.QLabel("Repeat times: "), 3, 0)
        self.textfieldTimes = QtGui.QLineEdit(self.center)
        ...
        #
        self.layout1.addWidget(QtGui.QLabel("Repeat distance: "), 4, 0)
        self.textfieldDistance = QtGui.QLineEdit(self.center)
        ...
        #
        self.layout1.addWidget(QtGui.QLabel("Repeat direction: "), 5, 0)
        self.boxDirection = QtGui.QComboBox(self.center)
...
class DialogMatch(QtGui.QDialog):
    f = ''
    path = ''
    ...
    def __init__(self, parentWindow):
        ...
        layout.addWidget(QtGui.QLabel("Target image"))
        
        self.center = QtGui.QWidget(self)
        self.layout1 = QtGui.QHBoxLayout(self.center)
        self.center.setLayout(self.layout1)
        self.buttonBrowse = QtGui.QPushButton("Choose File")
        self.buttonBrowse.clicked.connect(self.browse)
        self.layout1.addWidget(self.buttonBrowse)
        self.label = QtGui.QLabel("No File Chosen")
    ...
    def browse(self):
        self.f = QtGui.QFileDialog.getOpenFileName(self, 'Select File')
        if self.f:
...
class WindowHistogram(QtGui.QMainWindow):
    closed = False
    image = None
...
class DropFieldWidget(QtGui.QWidget):
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionPower = QtGui.QAction(MainWindow)
        self.actionEqualize = QtGui.QAction(MainWindow)
        self.actionShape = QtGui.QAction(MainWindow)
        self.actionMatch = QtGui.QAction(MainWindow)
        
        self.window.actionHistogram = QtGui.QAction(MainWindow)
    ...
    def closeEvent(self, e):
        if self.history is None \
            ...
            return
        while True:
            msgBox = QtGui.QMessageBox(self.window)
    ...
    def menuActionOpen(self):
        path = str(QtGui.QFileDialog.getOpenFileName(self.window, 'Open File'))
        self.openImage(path)

    def menuActionSave(self):
        path = str(QtGui.QFileDialog.getSaveFileName(self.window, 'Save File'))
